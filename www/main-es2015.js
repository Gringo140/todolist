...
const routes = [
    {
        path: "todo",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./todos/todos.module */ "./src/app/todos/todos.module.ts")).then(m => m.TodosModule)
    },
    {
        path: "**",
        redirectTo: "todo"
...
let TodoServiceService = class TodoServiceService {
    ...
    get() {
        ...
        return this.Http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].jsonbin.apiURL, options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((todoList) => { this.todoList = todoList; }, () => { }));
    }
    post(todo) {
        const todoList = [];
        ...
        todoList.push(todo);
        return this.put(todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => { this.todoList.push(todo); }, () => { }));
    }
    put(todoList) {
        const options = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
    ...
    delete(todo) {
        ...
        return this.put(newTodoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => {
...
TodoServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _shared_todo_service_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/todo-service.service */ "./src/app/todos/shared/todo-service.service.ts");
...
let TodoComponent = class TodoComponent {
    ...
    ngOnInit() {
        this.disabled = true;
        this.service.get().subscribe(() => { this.disabled = false; }, () => { this.router.navigate(['/todo']); });
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _shared_todo_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/todo-service.service */ "./src/app/todos/shared/todo-service.service.ts");
...
let TodolistComponent = class TodolistComponent {
    ...
    retry() {
        this.service.get().subscribe((todoList) => {
            this.error = false;
...
/* harmony import */ var _todolist_todolist_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todolist/todolist.component */ "./src/app/todos/todolist/todolist.component.ts");
...
module.exports = __webpack_require__(/*! C:\Users\Gringo\Desktop\Formation CDA M2i\modules\Formation Ionic\todo-list\src\main.ts */"./src/main.ts");
